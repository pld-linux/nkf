...
nkf to jeszcze jeden konwerter kodu kanji pomiędzy sieciami, hostami i
terminalami. Konwertuje wejście w kodzie kanji do konkretnego kodu
kanji, takiego jak 7-bitowy JIS, MS-kanji (przesunięty JIS), utf-8 lub
EUC. Jednym z unikalnych udogodnień nkf jest to, że rozpoznaje
wejściowy kod kanji. Aktualnie rozpoznaje 7-bitowy JIS, MS-kanji
(przesunięty JIS), utf-8 i EUC. Dzięki temu użytkownicy nie muszą znać
specyfikacji wejściowego kodu kanji.
...
zwraca wynik konwersji. Szczegóły konwersji podaje się przy pomocy
